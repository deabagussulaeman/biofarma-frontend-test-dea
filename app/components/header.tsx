        ...
        <header className="p-4 pl-12 pr-12 border-b border-gray-300">
            <div className="container mx-auto flex justify-between items-center">
                <div className="flex">
                    ...
                    />
                    <div className="ml-3">
                        <div className='h-3'><small><b>Ravel</b></small></div>
                        <div className='h-3'><small>Travel Solution by Randy</small></div>
                    </div>
                </div>
                <nav className="hidden md:flex space-x-4">
                    <a href="#" className="font-bold text-green-500">Home</a>
                    <a href="#" className="font-bold">Tempat Lain</a>
                    <a href="#" className="font-bold">Testimoni</a>
                </nav>
                <div className="md:flex items-center">
                    <div className="md:ml-4 hidden md:block">
                        <span className="float-left mr-2">Halo, reza</span>
                        <Image
